...
# Install DPP
RUN apt update && apt install --no-install-recommends -y libssl-dev zlib1g-dev libsodium-dev libopus-dev cmake pkg-config git && apt-get clean && rm -rf /var/lib/apt/lists/*
